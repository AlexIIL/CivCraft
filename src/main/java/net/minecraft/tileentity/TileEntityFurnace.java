...
public class TileEntityFurnace extends TileEntityLockable implements IUpdatePlayerListBox, ISidedInventory {
    ...
    public void setInventorySlotContents(int index, ItemStack stack) {
        boolean flag =
                stack != null && stack.isItemEqual(this.furnaceItemStacks[index])
    ...
    @SideOnly(Side.CLIENT) public static boolean isBurning(IInventory p_174903_0_) {
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            // EDIT START
            if (!MinecraftForgeNewHooks.canSmeltEvent(furnaceItemStacks[0], itemstack, worldObj, pos)) return false;
            // EDIT END
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            if (this.furnaceItemStacks[0].getItem() == Item.getItemFromBlock(Blocks.sponge) && this.furnaceItemStacks[0].getMetadata() == 1
                    && this.furnaceItemStacks[1] != null && this.furnaceItemStacks[1].getItem() == Items.bucket) {
